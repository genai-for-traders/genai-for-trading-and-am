...
def plot_cumulative_returns(pd_predictions: pd.DataFrame):
    pd_predictions["cum_return"] = pd_predictions.groupby(
        ["item_id"], group_keys=False
